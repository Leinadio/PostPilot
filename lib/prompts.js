...
function buildPrompt(type, postContent, voice, polarity, examples, wordCount) {
  ...
  if (polarity === 'desaccord') {
    systemParts.push("DÉSACCORD. Tu es en désaccord avec le propos du post. Tu contestes, tu nuances, tu opposes. Ton commentaire exprime une position contraire ou un point de friction. Si le commentaire approuve ou soutient le propos, il sera rejeté");
  } else {
    systemParts.push("ACCORD. Tu es en accord avec le propos du post. Tu soutiens, tu approuves, tu renforces. Ton commentaire exprime un alignement avec le propos. Si le commentaire conteste ou s'oppose au propos, il sera rejeté");
  }
