...
function buildPrompt(type, postContent, polarity, examples, wordCount) {
  ...
  systemParts.push("VARIÉTÉ SYNTAXIQUE. Chaque phrase du commentaire a une construction grammaticale distincte. Si deux phrases suivent le même patron structurel, le commentaire sera rejeté. Les structures emphatiques formulaires et les constructions de mise en relief prévisibles sonnent artificiel. Un commentaire dont les phrases suivent des schémas répétitifs ou prévisibles sera rejeté");
